        ...
        <main id="main" class="site-main" role="main">
            <div class="layui-collapse">
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">新闻列表</h2>
                    <div class="layui-colla-content layui-show">
                        <ul>
                            <c:forEach items="${newsList}" var="n">
                                <li style="padding: 5px">
                                    <a href="/news/${n.newsId}" title="ajax实现form表单提交" target="_blank">${n.newsTitle}</a>
                                </li>
                            </c:forEach>
                ...
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">关键字库</h2>
                    <div class="layui-colla-content layui-show">
                        <c:forEach items="${keywordList}" var="t">
                            <a href="/keyword/${t.keywordId}" style="font-size: ${t.newsCount/4+14}px" title="${t.newsCount}个话题" target="_blank">${t.keywordName}</a>
                        </c:forEach>
                    </div>
                </div>
            </div>
