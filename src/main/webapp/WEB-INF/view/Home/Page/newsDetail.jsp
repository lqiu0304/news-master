...
<rapid:override name="breadcrumb">
    ...
    <nav class="breadcrumb">
        ...
        <c:choose>
            <c:when test="${news.categoryList != null && news.categoryList.size() > 0}">
                <c:forEach items="${news.categoryList}" var="c">
...
<rapid:override name="left">
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            <article class="post" id="newsDetail" data-id="${news.newsId}">
                ...
                <div class="entry-content">
                            ...
                            <span class="like">
                                <a href="javascript:;" data-action="ding" data-id="1" title="点赞"
                                   class="favorite" onclick="increaseLikeCount()">
                                    ...
                                    <i class="count"
                                       id="count-${news.newsId}">${news.newsLikeCount}</i>
                                </a>
                            </span>
                            <div class="shang-p">
                                <div class="shang-empty"><span></span></div>
                                <span class="shang-s">
                                    <a onclick=";" style="cursor:pointer"></a>
                                </span>
                            </div>
                            <div class="share-sd">
                    ...
                    <footer class="single-footer">
                        <ul class="single-meta">
                            <c:if test="${sessionScope.user!=null && (sessionScope.user.userId == news.newsUserId || sessionScope.user.userRole == 'admin')}">
                                <li class="edit-link">
                                    <a  class="post-edit-link"
                                       href="/admin/news/edit/${news.newsId}">编辑</a>
                                </li>
                            </c:if>
                            <li class="comment">
                                <a href="/news/${news.newsId}#comments"
                            ...
                            <li class="views">
                                <i class="fa fa-eye"></i> <span
                                    class="newsViewCount">${news.newsViewCount}</span>
                                views
                            </li>
                            <li class="r-hide">
            ...
            <div class="single-tag">
                <ul class="" data-wow-delay="0.3s">
                    <c:forEach items="${news.keywordList}" var="t">
                        <li>
                            <a href="/keyword/${t.keywordId}" rel="keyword"
            ...
            <div class="authorbio wow fadeInUp">
                <img alt="${news.user.userNickname}" src="${news.user.userAvatar}"
                     class="avatar avatar-64 photo" height="64" width="64">
                <ul class="postinfo">
                    <li></li>
                    <li><strong>版权声明：</strong>本站原创新闻，于<fmt:formatDate
                            value="${news.newsCreateTime}"
                            pattern="yyyy-MM-dd"/>，由
                        <strong>
                                ${news.user.userNickname}
                        </strong>
                        发表。
                    </li>
                    <li class="reprinted"><strong>转载请注明：</strong>
                        <a href="/news/${news.newsId}"
                           rel="bookmark"
                           title="本文固定链接 /news/${news.newsId}">
                                ${news.newsTitle} | ${options.optionSiteTitle}</a>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
            ...
            <div id="single-widget">
                <div class="wow fadeInUp" data-wow-delay="0.3s">
                    <aside id="related_post-2" class="widget hot_post">
                        <h3 class="widget-title">
                            <span class="s-icon"></span>相关新闻
                        </h3>
                        <div id="related_post_widget">
                            <ul>
                                <c:forEach items="${similarNewsList}" var="s">
                                    <li>
                                        <a href="/news/${s.newsId}">${s.newsTitle}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                    ...
                    <aside id="hot_post-8" class="widget hot_post">
                        ...
                        <div id="hot_post_widget">
                            <ul>
                                <c:forEach items="${mostViewNewsList}" var="m">
                                    <li>
                                        <a href="/news/${m.newsId}">
                                                ${m.newsTitle}
                                        </a>
                                    </li>
                                </c:forEach>
            ...
            <nav class="nav-single">
                <c:choose>
                    <c:when test="${preNews!=null}">
                        <a href="/news/${preNews.newsId}" rel="next">
                            <span class="meta-nav">
                                <span class="post-nav">上一篇
                                 <i class="fa fa-angle-left"></i>
                                </span>
                                <br>${preNews.newsTitle}
                            </span>
                        </a>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${afterNews!=null}">
                        <a href="/news/${afterNews.newsId}" rel="next">
                            <span class="meta-nav">
                                <span class="post-nav">下一篇
                                 <i class="fa fa-angle-right"></i>
                                </span>
                                <br>${afterNews.newsTitle}
                            </span>
                        </a>
                    </c:when>
                    <c:otherwise>
                ...
                <div id="respond" class="comment-respond">
                    <h3 id="reply-title" class="comment-reply-title"><span id="reply-title-word">发表评论</span>
                        <a rel="nofollow" id="cancel-comment-reply-link"
                           href="/news/${news.newsId}#respond"
                           style="">取消回复</a>
                        <c:if test="${sessionScope.user == null}">
                            <span style="color:red">您未登录，登录后才能评论，<a href="/login"  >前往登录</a></span>
                        </c:if>
                    </h3>
                    ...
                    <form id="comment_form" method="post">
                        <c:if test="${sessionScope.user!=null}">
                            <div class="user_avatar">
                                ...
                                <br> <a href="javascript:void(0)" onclick="logout()">退出登录</a>
                            </div>
                        </c:if>
                        <%--评论内容--%>
                        ...
                        <p class="form-submit">
                            ...
                            <input type="hidden" name="commentNewsId"
                                   value="${news.newsId}" id="news_id">
                                        ...
                                        <span class="comment-meta commentmetadata">
                                            <span class="ua-info" style="display: inline;">
                                                ...
                                                <span class="comment-aux">
                                                    ...
                                                    <c:if test="${sessionScope.user != null && sessionScope.user.userId == news.newsUserId}">
                                                ...
                                                <div id="div-comment-${c.commentId}" class="comment-body">
                                                    ...
                                                    <span class="comment-aux">
                                                        ...
                                                        <c:if test="${sessionScope.user != null}">
                                                            ...
                                                            <a class="comment-edit-link"
                                                               href="/admin/comment/edit/${c2.commentId}" >编辑</a>
                                                        </c:if>
...
<rapid:override name="footer-script">
    ...
    <script type="text/javascript">
        ...
        var newsId = $("#newsDetail").attr("data-id");
        ...
        function increaseLikeCount() {
            if ($.cookie("likeId") != newsId || $.cookie("likeId") == null) {
                $.ajax({
                    async: false,
                    type: "POST",
