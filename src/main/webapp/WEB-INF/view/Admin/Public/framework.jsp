...
<head>
    <meta charset="utf-8">
    <!-- 上述3个meta关键字*必须*放在最前面，任何其他内容都*必须*跟随其后！ -->
    <link rel="shortcut icon" href="/img/logo.png">
    <title>
        ${options.optionSiteTitle}新闻后台
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo"><a href="/admin" style="color:#009688;">
            ${options.optionSiteTitle}新闻管理后台
        </a>
        </div>
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="/admin/news/insert">新闻</a></dd>
            ...
            <c:if test="${sessionScope.user != null && sessionScope.user.userRole == 'admin'}">
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="/admin/news">全部新闻</a></dd>
                            <dd><a href="/admin/news/insert">发布新闻</a></dd>
                            <dd><a href="/admin/category">新闻分类</a></dd>
                            <dd><a href="/admin/keyword">新闻关键字</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
            ...
            <c:if test="${sessionScope.user != null && sessionScope.user.userRole == 'user'}">
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="/admin/news">我的新闻</a></dd>
                            <dd><a href="/admin/news/insert">新闻投稿</a></dd>
