            ...
            <div id="dashboard_quick_press" class="postbox ">
                <div class="inside">
                    <form name="post" method="post" id="insertDraftForm"
                          class="initial-form hide-if-no-js" action="/admin/news/insertDraftSubmit">
                        ...
                        <div class="layui-form-item layui-form-text">
                            <div class="layui-input-block">
                                <textarea name="newsContent" placeholder="请输入内容" id="newsContent" class="layui-textarea" required></textarea>
                            </div>
                        </div>
                        <input type="hidden" name="newsStatus" value="0">
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                    ...
                    <div class="drafts"><p class="view-all"><a
                        ...
                        <ul>
                            <c:forEach items="${newsList}" var="n">
                                <c:if test="${n.newsStatus==0}">
                                    <li>
                                        <div class="draft-title"><a
                                                href="/admin/news/edit/${n.newsId}">${n.newsTitle}</a>
                                            <time ><fmt:formatDate value="${n.newsCreateTime}" pattern="yyyy年MM月dd日"/></time>
                                        </div>
                                    </li>
                                </c:if>
                            </c:forEach>
